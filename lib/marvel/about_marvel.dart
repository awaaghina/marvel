...
class AboutMarvel extends StatelessWidget {
  const AboutMarvel({super.key});
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                CircleAvatar(
                  radius: 50.0,
                  backgroundImage: AssetImage('assets/images/logo_marvel1.jpg'),
                ),
                SizedBox(height: 20.0),
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Text(
                          'Explore the Marvel World with Us',
                          style: TextStyle(
                            fontSize: 24.0,
                        ...
                        Text(
                          'We are dedicated to providing the best marvel experiences to our fans. Our mission is to help you discover the beauty and magic of the Marvel universe, one character at a time.',
